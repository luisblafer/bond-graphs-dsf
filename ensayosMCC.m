%% ENSAYOS DE COMPORTAMIENTOS DINAMICOS CON 20SIM PARA EL MCC-IP
% SE GRAFICAN AQUI LOS RESULTADOS DE LOS DIVERSOS ENSAYOS QUE SE REALIZARON
% PARA EL MOTOR DE CORRIENTE CONTINUA BAJO DIFERENTES CONDICIONES Y EN
% DIVERSOS PUNTOS DE OPERACION.
% 
...
%% ELEGIMOS EL ENSAYO
ensayoChosen = 'ensayo_5';


%% IMPORTAR LOS DATOS DEL ENSAYO COMO TABLA
path = sprintf('/Users/luis/Documents/MATLAB/BG/input/tests/%s.csv', ...
               ensayoChosen);
ensayo = importfile(path, [2, Inf]);


%% AGREGAR LOS METADATOS

% AGREGAMOS LAS UNIDADES DE LAS VARIABLES DE NUESTRO ENSAYO
ensayo.Properties.VariableUnits = ...
    {'s' 'V' 'N m' 'A' 'rad/s' 'Wb' ...
    'N m s' '' '' 'V' 'N m'};

% INGRESAMOS LAS DESCRIPCIONES DE LAS VARIABLES DE NUESTRO ENSAYO
ensayo.Properties.VariableDescriptions = ...
    {'Time' ...
    'Tensión de armadura' ...
    'Torque de carga' ...
    'Corriente de armadura' ...
    'Velocidad angular' ...
    'Variable de estado eléctrica' ...
    'Variable de estado mecánica' ...
    'Perfil de tensión de armadura' ...
